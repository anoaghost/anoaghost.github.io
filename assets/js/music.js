function playRandomSong() {
  var songs = [
    "../music/ACHanime_Rachel_(CV._Haruka_Chisuga)_-_Pray.mp3",
    "../music/[ACHanime]_Asaka_-_Marine_SNOW.mp3",
    "../music/[ACHanime]_MYTH___ROID_-_VORACITY.mp3",
    "../music/[ACHanime]_Sangatsu_no_Phantasia_-_Rubicon.mp3"
  ];
